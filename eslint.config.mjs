...
/**
 * @todo Remove the type assertion once the type definitions are fixed in {@linkcode https://github.com/vitest-dev/eslint-plugin-vitest#readme | @vitest/eslint-plugin}.
 * @type {Linter.Config}
 */
const vitestEnv = /** @type {Linter.Config} */ (vitestPlugin.configs.env);
